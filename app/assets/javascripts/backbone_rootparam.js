...
Backbone.RailsJSON = {
  ...
  _name : function() {
    if (!this.paramRoot) throw new Error("A 'name' property must be specified");
...
_.extend(Backbone.Model.prototype, Backbone.RailsJSON, {
  ...
  toJSON : function(opts) {
    opts || (opts={});
    return opts.wrapped===false ? this.attributes : this.wrappedAttributes();
  },
